...
const ListaClientes = () => {
    ...
    const manejarCambioInput = (evento) => {
        ...
        } else if (name === 'city' || name === 'street' || name === 'number' || name === 'zipcode') {
            setNuevoCliente({
                ...nuevoCliente,
                address: {
    ...
    const agregarCliente = async () => {
        try {
            ...
            const clienteCompleto = {
                id: nuevoId,
                name: {
                    firstname: clienteAgregado.name?.firstname || nuevoCliente.name.firstname,
                    lastname: clienteAgregado.name?.lastname || nuevoCliente.name.lastname
                },
                ...
                address: {
                    ...
                    street: clienteAgregado.address?.street || nuevoCliente.address.street,
                    number: clienteAgregado.address?.number || nuevoCliente.address.number,
                    zipcode: clienteAgregado.address?.zipcode || nuevoCliente.address.zipcode
                }
            };
            ...
            setMensajeNotificacion(`Cliente ${clienteCompleto.name.firstname} ${clienteCompleto.name.lastname} agregado con éxito!`);
            setNotificacionAbierta(true);

            cerrarModal();

        } catch (error) {
            setMensajeNotificacion('Error al agregar el cliente. Por favor, intente nuevamente.');
            setNotificacionAbierta(true);
        }
    };
                    ...
                    <TableBody>
                        {clientesFiltrados.map((cliente) => (
                            <TableRow key={cliente.id}>
                                ...
                                <TableCell>
                                    {cliente.name?.firstname || 'Sin nombre'} {cliente.name?.lastname || ''}
                                </TableCell>
